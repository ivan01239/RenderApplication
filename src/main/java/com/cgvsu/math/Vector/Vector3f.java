...
public class Vector3f extends Vector {
    ...
    public static Vector3f javaToOur (javax.vecmath.Vector3f javaVector){
       float[] newVector = new float[3];
       javaVector.get(newVector);
        return new Vector3f(newVector);
    }

    public static javax.vecmath.Vector3f ourToJava(Vector3f ourVector) {
        return new javax.vecmath.Vector3f(ourVector.getVector());
    }
}