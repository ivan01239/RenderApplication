...
public class Model {
    public Matrix4f rotateScaleTranslate = rotateScaleTranslate();
    ...
    public Model(final List<Vector3f> vertices, final List<Vector2f> textureVertices, final List<Vector3f> normals, final List<Polygon> polygons) {
        ...
        this.textureVertices = (ArrayList<Vector2f>) textureVertices;
        this.normals = (ArrayList<Vector3f>) normals;
